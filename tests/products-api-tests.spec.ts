...
test.describe('Lesson 11 -> product API tests', () => {
  ...
  test('DELETE/ products; POST/ products - check existing product deletion', async ({
    request,
  }) => {
  ...
  test('POST/products; GET/products - check all product creation and products search', async ({
    request,
  }) => {
